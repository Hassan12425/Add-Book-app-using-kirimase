...
import { TAddOptimistic } from "@/app/(app)/reflection/useOptimisticReflection";
import { type Reflection } from "@/lib/db/schema/reflection";
  ...
  return (
    <div className="m-4">
      ...
      <div className="flex justify-between items-end mb-4">
        <h1 className="font-semibold text-2xl">{optimisticReflection.content}</h1>
